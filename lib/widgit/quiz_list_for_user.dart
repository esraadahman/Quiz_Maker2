...
class quiz_widgit_for_user extends StatefulWidget {
  quiz_widgit_for_user({
    super.key,
    required this.l,
  });
  quizmodel? l;
  ...
  @override
  State<quiz_widgit_for_user> createState() => _PostState();
}

class _PostState extends State<quiz_widgit_for_user> {
  @override
          ...
          child: Stack(
            children: [
              if(widget.l?.quiz_image!=null && widget.l!.quiz_image!.startsWith("http"))
                ...
                Center( child:  Icon(CupertinoIcons.photo, color: Colors.lightBlue,
                  size: 150,
                ),),
              Container(
                alignment: Alignment.topRight,
                child: IconButton(
                  icon: Icon(Icons.delete ,color: text_color,), // Icon to display
              onPressed: () {
                    setState(() {
                      firestore.removeQuiz(widget.l!.quiz_id.toString());
                    });
